...
public class Practice {
    ...
    public static void main(String[] args) {
        ...
        // Writting the name and surname with uppercase(first letter)
        String fullNameCorrect = fullName.substring(0, 1).toUpperCase() + fullName.substring(1, indexOfBeginningLastName)
                + "" + fullName.substring(indexOfBeginningLastName, indexOfBeginningLastName + 1).toUpperCase()
                + fullName.substring(indexOfBeginningLastName + 1);
